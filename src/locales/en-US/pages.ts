export default {
  ...
  'app.dev.openApiDocs': 'OpenAPI Docs',
  'app.request.responseStatus': 'Response status: {status}',
  'app.request.noneResponseRetry': 'No response received. Please retry.',
  'app.request.errorRetry': 'Request error, please retry.',
  'app.request.failed': 'Request failed!',
  'pages.button.deleteMessage': 'Are you sure you want to delete this data?',
