export default {
  ...
  'pages.FlowProperties.view.flowPropertiesInformation.synonyms': 'Synonyms',
  ...
  'pages.FlowProperties.view.modellingAndValidation.referenceToDataSource': 'Data source',
